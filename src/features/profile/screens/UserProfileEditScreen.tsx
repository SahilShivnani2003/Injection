...
// import { RegisterForm } from '../../auth/types/RegisterForm';
...
export const UserProfileEditScreen = ({ navigation, route }: EditProfileProps) => {
      ...
      //         role: 'user',
      //     });
      const [form, setForm] = useState<EditForm>(userData);
            ...
            try {
                  ...
                  if (response.data.success) {
                        alert.success(
                              ...
                              'Your profile has beed updated.',
                        );
                        navigation.goBack();
                  } else {
                        alert.error('Upadtaion failed', 'Unable to update profile. Please try again.');
                  }
            } catch (error) {
                  alert.error(
                        'Profile upadtaion failed',
                  ...
                  >
                        <View style={styles.headerRow}>
                              ...
                              <View style={styles.headerCenter}>
                                    <Text style={styles.headerTitle}>Edit Profilet</Text>
                  ...
                  >
                        ...
                        >
                              {loading ? (
                                    ...
                                    <Text style={styles.registerBtnText}>Save</Text>
                              )}
                        </TouchableOpacity>
                  </ScrollView>
            </View>
