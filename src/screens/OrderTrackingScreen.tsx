...
const OrderTrackingScreen = ({ navigation }: OrderTrackingProps) => {
  ...
  const statuses = [
    ...
    { key: 'collected', label: 'Sample Collected', icon: '🩸', desc: 'Sample collected successfully' },
    { key: 'processing', label: 'Processing', icon: '🔬', desc: 'Tests are being processed' },
    { key: 'ready', label: 'Report Ready', icon: '📄', desc: 'Your report is ready to download' },
  ];
...
const styles = StyleSheet.create({
  ...
  testsTitle: { fontSize: 16, fontWeight: '600', color: Colors.textDark, marginTop: 12, marginBottom: 8 },
