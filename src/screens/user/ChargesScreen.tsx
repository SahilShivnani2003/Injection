    ...
    const handleConfirmBooking = async () => {
        try {
            ...
            const bookingRequest: CreateBookingRequestDTO = {
                ...
                selectedServices: bookingData.selectedServices!.map(id => ({
                    serviceId: id,
                    quantity: 1,
                    specialInstructions: '',
                })),
                complimentaryTests: bookingData.complimentaryTests,
                ...
                preferredStaff:
                    bookingData.selectedStaff === 'any'
                        ? 'Any Available'
                        : bookingData.selectedStaff === 'male'
                        ? 'Male Staff'
                        : 'Female Staff',
                additionalRequirements: '',
                prescriptionDocument: bookingData.prescriptionFile?.serverUrl,
                serviceLocation: bookingData.currentLocation,
            };

            // Validate booking data
            const validationErrors = validateCreateBookingRequestDTO(bookingRequest);
                    ...
                    >
                        ...
                        >
                            ...
                            <View style={styles.confirmArrow}>
                                <Text style={styles.confirmArrowText}>
                                    {isLoading ? '⏳' : '✓'}
                                </Text>
                            </View>
                        </LinearGradient>
