...
const metricCards = [
    ...
    { label: 'Prescriptions', value: '5', color: '#E8FFF1', icon: '💊' },
    { label: 'Completed', value: '19', color: '#FFF9E6', icon: '✅' },
    { label: 'Messages', value: '3', color: '#F5E8FF', icon: '💬' },
];
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                >
                    <LinearGradient
                        ...
                        style={styles.bookFollowUpGradient}
                    >
                        <Text style={styles.bookFollowUpIcon}>📅</Text>
                        <Text style={styles.bookFollowUpText}>Book Follow-up</Text>
                    </LinearGradient>
                </TouchableOpacity>
                ...
                <View style={styles.activityCard}>
                    ...
                    <Text style={styles.activityText}>
                        You completed 4 nurse visits last week. Keep up the excellent progress!
                    </Text>
                </View>
            </ScrollView>
        </View>
...
const styles = StyleSheet.create({
    ...
    activityText: { color: Colors.textDark, fontSize: 14, lineHeight: 20, flex: 1 },
    logoutBtn: {
        marginTop: 24,
        alignSelf: 'center',
        borderWidth: 1,
